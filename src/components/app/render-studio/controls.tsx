...
export function RenderStudioControls({
  ...
  return (
    ...
    <div className="h-fit max-w-full overflow-hidden rounded-lg border border-border/80 bg-card lg:h-full lg:min-h-0 lg:rounded-none lg:border-y-0 lg:border-l-0">
