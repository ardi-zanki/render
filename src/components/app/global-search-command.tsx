  ...
  return (
    <>
      <button
        ...
        className="group relative grid w-full grid-cols-[40px_minmax(0,1fr)] items-center rounded-md py-1.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted/80 hover:text-foreground"
      >
